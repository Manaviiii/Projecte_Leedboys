        ...
        <footer className="footer">
            <div className="footer-main">
                <div className="footer-brand">
                    ...
                    <p>Transformamos tus eventos en experiencias inolvidables. Animación, espectáculo y baile para todo tipo de eventos.</p>
                </div>
                ...
                <div className="footer-social">
                    ...
                    <div className="footer-social-links">
                        <a className="footer-social-link" href="https://www.instagram.com/ledboyss/?hl=es" target="_blank" rel="noopener noreferrer">
                            <div className="footer-social-icon">📸</div>@Ledboyss
                        </a>
