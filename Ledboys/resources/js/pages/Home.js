    ...
    return (
        <div>
            ...
            <section className="about">
                ...
                <p>
                    Transformamos tus eventos en experiencias inolvidables. Con nuestra pasión
                    por la música, danza y el entretenimiento, ofrecemos servicios de animación
                    personalizados para discotecas, bodas y eventos de todo tipo, asegurando
                    que cada celebración sea única y llena de energía.
                </p>
                <p>
                    Nuestro equipo de profesionales se encarga de cada detalle, desde ofrecer
                    la temática que más se adapte a tu fiesta, hasta la interacción con el
                    público divertida, creando sonrisas e inolvidables momentos únicos que
                    quedarán para siempre en el recuerdo.
                </p>
                <p>
                    Déjanos ser parte de tu gran día o de tu fiesta, y juntos haremos que sea
                    espectacular e inmejorable. ¡Contáctanos y descubre cómo podemos hacer de
                    tu evento algo realmente diferente y especial!
                </p>
